...
/**
 * sort_deck - this is to sort a deck of card
 * @deck: this is the doubly linked list to sort
 */
...
/**
 * card_value - this is to return the value of a card
 * @node: this is the card in a deck
 *
...
/**
 * _strcmp - thisis to compare two strings
...
/**
 * list_len_deck -this is the  function returns length of list
